...
namespace INSTANCIATAREA
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var menosmontos = (from i in listafactura where i.Total<6
                             join t in listacliente on i.Idcliente equals t.Id
                             select new
                             {
                                 TotalFactura = i.Total,
            ...
            foreach (var item in menosmontos)
            {
                Console.WriteLine("{0}\t ${1}", item.Nombre, item.TotalFactura);
            }
            /////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            {
                double valorMaximo = listafactura.Max(elemento => elemento.Total);
                Console.WriteLine("Cliente: {0} con total de ventas: {1}", item.Nombre, valorMaximo);
            }
            ...
            var ventaAntigua = listafactura.Min(elemento => elemento.Fecha);
            Console.WriteLine(ventaAntigua);

            //////////////////////////////////////////////////////////////////////////////////
            Console.WriteLine("Última venta realizada");
            var ultimaventa = listafactura.Max(elemento => elemento.Fecha);
